...
function preload(){
  ...
  table = loadTable('data/20210302_mmm_data - Hoja 1.csv', 'csv');
  //icon = loadImage(flatEric);//media/img/thumbnail/sample.gif");
  /*
allIcons[0] = loadImage("media/img/portada/Portada_NicolasRoman.jpg");
allIcons[1] = loadImage("media/img/portada/Portada_AaronMaureira.jpg");
allIcons[2] = loadImage("media/img/portada/Portada_Alberto.jpg");
allIcons[3] = loadImage("media/img/portada/Portada_MartinaFernandez.jpg");
allIcons[4] = loadImage("media/img/portada/Portada_MariaVillegas.jpg");
allIcons[5] = loadImage("media/img/portada/Portada_RenatoPeña.jpg");
allIcons[6] = loadImage("media/img/portada/Portada_AlbertoEspinosa.jpg");
allIcons[7] = loadImage("media/img/portada/Portada_AgustinEspinosa.jpg");
allIcons[8] = loadImage("media/img/portada/Portada_MillarayFreire.jpg");
allIcons[9] = loadImage("media/img/portada/Portada_EmilianoVillarroel.jpg");
allIcons[10] = loadImage("media/img/portada/Portada_RafaelHernández.jpg");
allIcons[11] = loadImage("media/img/portada/Portada_RodrigoSoto.jpg");
allIcons[12] = loadImage("media/img/portada/Portada_CatrinaCapurro.jpg");
allIcons[13] = loadImage("media/img/portada/Portada_FlorenciaFolch.jpg");
allIcons[14] = loadImage("media/img/portada/Portada_CarlaBordagaray.jpg");
allIcons[15] = loadImage("media/img/portada/Portada_LucíaRodríguez.jpg");
allIcons[16] = loadImage("media/img/portada/Portada_JavieraFarfán.jpg");
allIcons[17] = loadImage("media/img/portada/Portada_DanielMendez.jpg");
allIcons[18] = loadImage("media/img/portada/Portada_DavidCancino.jpg");
allIcons[19] = loadImage("media/img/portada/Portada_NohemiMendez.jpg");
allIcons[20] = loadImage("media/img/portada/Portada_RenéCarpio.jpg");
allIcons[21] = loadImage("media/img/portada/Portada_RenatoValdenegro.jpg");
allIcons[22] = loadImage("media/img/portada/Portada_JuanGonzáles.jpg");
allIcons[23] = loadImage("media/img/portada/Portada_MartinMuñoz.jpg");
allIcons[24] = loadImage("media/img/portada/Portada_MaríaVillegas.jpg");
allIcons[25] = loadImage("media/img/portada/Portada_Massiel.jpg");
allIcons[26] = loadImage("media/img/portada/Portada_BenjamínBorges.jpg");
allIcons[27] = loadImage("media/img/portada/Portada_BenjamínZapata.jpg");
allIcons[28] = loadImage("media/img/portada/Portada_AlanGarcia.jpg");
allIcons[29] = loadImage("media/img/portada/Portada_SebastianAcevedo.jpg");*/
}
...
function parseCSV(){
  audioNodes = [];
  for (let r = 0; r < table.getRowCount()/5; r++){
...
function AudioNode(i){
  ...
  this.filename1       = "media/audio/master/"+table.getString(this.index, 1);//natural
  this.filename2       = "media/audio/pitch/"+table.getString(this.index, 2);//warp
  this.filename3       = "media/img/portada/"+table.getString(this.index, 3);//thumb
  this.filename4       = this.filename3;//"media/img/background/"+table.getString(this.index, 4);//bg

  this.gainVals          = [];
  this.panVals           = [];
  
  for(var j=0; j<5; j++){
    this.gainVals[j] = table.getString(this.index, 5+2*j);//
    this.panVals[j]  = table.getString(this.index, 5+2*j+1);//
  }
